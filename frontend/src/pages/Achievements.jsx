...
export function Achievements() {
  ...
  return <>
      ...
      <div className="page-grid cols-3">
        {achievements.map(a => <SystemWindow key={a.id} title={a.title} style={{
        ...
        boxShadow: a.unlocked && rarityGlow[a.rarity] !== 'transparent' ? `0 0 18px ${rarityGlow[a.rarity]}` : undefined
          ...
          gap: 12
            ...
            filter: a.unlocked ? 'none' : 'grayscale(1) brightness(0.6)'
                ...
                <ProceduralIcon seed={a.title} category={resolveAchievementIconCategory(a)} color={RARITY_COLOR[a.rarity] ?? RARITY_COLOR.common} size={30} />
              </div>
              <div style={{
            minWidth: 0,
            flex: 1
              ...
              flexWrap: 'wrap'
                ...
                fontWeight: 700
                  ...
                  <span className={`badge ${rarityBadge[a.rarity] ?? ''}`} style={{
                fontSize: 9
              }}>
                    {a.rarity}
                  </span>
          ...
          flexWrap: 'wrap'
              ...
              {a.unlocked ? <span className="badge green" style={{
            fontSize: 10
          }}>
            ...
            fontSize: 10
              ...
              {a.rewards?.xp ? <span className="badge blue" style={{
            fontSize: 10
          }}>+{a.rewards.xp} XP</span> : null}
              {a.rewards?.gold ? <span className="badge gold" style={{
            fontSize: 10
          }}>+{a.rewards.gold} Gold</span> : null}
