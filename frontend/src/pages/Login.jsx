...
export function Login() {
  ...
  return <div className="auth-shell">
      <div className="auth-card">
        ...
        {knownAccounts.length > 0 && <SystemWindow title="Continue As" style={{
        marginBottom: 16
      }}>
            {knownAccounts.map(a => <div key={a.id} className="list-row" style={{
          display: 'flex',
          alignItems: 'center',
          gap: 8
        }}>
            ...
            cursor: 'pointer'
          }} onClick={() => setEmail(a.email)}>select</span>
                <span className="badge" title="Remove from this list" style={{
            cursor: 'pointer',
            color: 'var(--danger)'
          }} onClick={e => {
            e.stopPropagation();
        ...
        color: 'var(--text-dim)'
          ...
          No account yet? <Link to="/create-character" style={{
