 ...
 */
function computeTargets(weightKg, ageYears) {
  let kcalPerKg;
  if (ageYears < 18) kcalPerKg = 45;else if (ageYears <= 30) kcalPerKg = 40;else if (ageYears <= 50) kcalPerKg = 37;else kcalPerKg = 33;
  ...
  return <>
      ...
      <SystemWindow title="Daily Targets">
        ...
        flexWrap: 'wrap'
          ...
          <input className="input" type="number" min={5} max={120} placeholder="Age (years)" value={ageInput} onChange={e => setAgeInput(e.target.value)} style={{
          flex: 1,
          minWidth: 120
        }} />
          <input className="input" type="number" min={15} placeholder="Weight (kg)" value={weightInput} onChange={e => setWeightInput(e.target.value)} style={{
          flex: 1,
          minWidth: 120
        }} />
