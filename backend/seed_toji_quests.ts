...
const QUEST_LINES: QuestLine[] = [
  {
    ...
    icon: 'quest-core',
    title: 'Steel Core',
    goalSummary: 'Develop visible abs and a powerful core.',
    requirements: ['Leg Raises', 'Hanging Knee Raises', 'Planks', 'L-Sit Progression'],
    rewardText: '+Core Stat, +Endurance, +Physique Points',
    ranks: [
      { rank: 'F', goal: 'Leg Raises', goalValue: 30 },
      { rank: 'E', goal: 'Plank Hold (seconds)', goalValue: 60 },
      { rank: 'D', goal: 'Hanging Knee Raises', goalValue: 15 },
      { rank: 'C', goal: 'Achieve visible upper abs', goalValue: 1 },
      { rank: 'B', goal: 'L-Sit Hold (seconds)', goalValue: 10 },
      { rank: 'A', goal: 'Reach a strong athletic core', goalValue: 1 },
    ],
  },
  {
    ...
    goalSummary: 'Build an enormous V-Taper.',
    requirements: ['Pull Ups', 'Wide Pull Ups', 'Chin Ups', 'Dead Hangs', 'Towel Pull Ups'],
    ...
    ranks: [
      ...
      { rank: 'B', goal: 'Backpack-Weighted Pull Ups', goalValue: 1 },
      { rank: 'A', goal: 'Achieve a massive V-Taper', goalValue: 1 },
    ],
  },
  {
    ...
    icon: 'quest-arms',
    title: 'Titan Arms',
    goalSummary: 'Massive Arms.',
    requirements: ['Chin Ups', 'Diamond Push Ups', 'Backpack Curls', 'Close Grip Push Ups'],
    rewardText: '+Strength, +Aesthetic Bonus',
    ranks: [
      { rank: 'F', goal: 'Push Ups', goalValue: 30 },
      { rank: 'E', goal: 'Chin Ups', goalValue: 15 },
      { rank: 'D', goal: 'Chin Ups', goalValue: 20 },
      { rank: 'C', goal: 'Measurable arm circumference increase', goalValue: 1 },
    ],
  },
  {
    ...
    icon: 'quest-grip',
    title: 'Iron Grip',
    goalSummary: 'Massive Forearms and Grip.',
    requirements: ['Dead Hangs', 'Towel Hangs', 'Towel Pull Ups', 'Backpack Carries'],
    ...
    ranks: [
      ...
      { rank: 'B', goal: 'Backpack-Weighted Dead Hangs', goalValue: 1 },
    ],
  },
  {
    ...
    goalSummary: 'Massive shoulders.',
    requirements: ['Pike Push Ups', 'Handstand Progression', 'Elevated Pike Push Ups', 'Backpack Shoulder Exercises'],
    rewardText: '+V-Taper, +Athletic Look',
    ranks: [
      { rank: 'F', goal: 'Pike Push Ups', goalValue: 10 },
      { rank: 'E', goal: 'Pike Push Ups', goalValue: 20 },
      { rank: 'D', goal: 'Handstand Hold', goalValue: 1 },
      { rank: 'C', goal: 'Achieve visible shoulder width', goalValue: 1 },
    ],
  },
  {
    ...
    icon: 'quest-legs',
    title: 'Monster Legs',
    goalSummary: 'Athletic, explosive legs.',
    requirements: ['Squats', 'Jump Squats', 'Bulgarian Split Squats', 'Lunges', 'Calf Raises'],
    rewardText: '+Speed, +Explosiveness, +Sprint Performance',
    ranks: [
      { rank: 'F', goal: 'Squats', goalValue: 20 },
      { rank: 'E', goal: 'Squats', goalValue: 40 },
      { rank: 'D', goal: 'Jump Squats', goalValue: 15 },
      { rank: 'C', goal: 'Bulgarian Split Squats (each leg)', goalValue: 10 },
      { rank: 'B', goal: 'Walking Lunges (each leg)', goalValue: 20 },
    ],
  },
  {
